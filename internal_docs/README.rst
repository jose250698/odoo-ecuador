...
Permite el manejo de documentos internos como cheques, comprobantes de ingreso y egreso, entre otros.

Se usa principalmente para control interno de la empresa.
...
* Automatizar la actualización de la secuencia_actual al generar el secuencial de la factura en comprobantes y retenciones.
* Generar el ATS.
