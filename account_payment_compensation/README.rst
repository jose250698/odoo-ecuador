...
=============================
Account payment compensations
=============================

Compensate payables and receivables.

TO DO:
======
- Add journal and account on instalation.
- Constraint to forbid other payment methods in compensation journal.
- Contranint to assure that debit and credit account on journal is the same.
