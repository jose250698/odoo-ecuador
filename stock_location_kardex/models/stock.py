...
class StockLocationKardexLine(models.Model):
    ...
    balance_qty = fields.Float('Balance qty', digits_compute=dp.get_precision('Product Unit of Measure'), )
    previous_balance_qty = fields.Float('Previous balance qty', digits_compute=dp.get_precision('Product Unit of Measure'), )
...
class StockLocationKardex(models.Model):
    ...
    def prepare_kardex_line_dict(self, move, balance, value, sequence):
        ...
        vals = {
            ...
            'counterpart_location_id': counterpart_location.id,
        }
    ...
    def button_update_kardex(self, moves=False):
        ...
        for move in moves:
            sequence += 1
            vals, balance_qty, balance_value = self.prepare_kardex_line_dict(move, balance, value, sequence)
